...
base = pd.read_csv("C:/Users/ahmet/OneDrive/Masaüstü/Pyhton Files/StudentsPerformance.csv")
...
# corr = y_testDf.corrwith(y_pred)
# corr1 = y_testDf.corrwith(y_pred1)
# corr2 = y_testDf.corrwith(y_pred2)